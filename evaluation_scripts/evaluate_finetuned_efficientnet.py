import json, time, os, csv, itertools
...
CKPT_PATH = r"C:\Users\Kistanov\Desktop\Grocery-Product-Recognition\finetuned_models\efficientnet_fruits_b0.pth"
...
def get_model(num_classes, ckpt_path=None):
...
if __name__ == "__main__":
    ...
    model = get_model(len(ds.class_names), ckpt_path=CKPT_PATH)
    ...
    out_dir = Path(OUT_DIR) / f"efficientnet_b0_finetuned_test"
    ...
    print(f"[EfficientNet-B3 fruits] test acc={acc:.4f} | n={len(ds)} | {elapsed:.1f}s -> {out_dir.resolve()}")
